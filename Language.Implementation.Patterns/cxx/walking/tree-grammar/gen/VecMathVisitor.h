...
public:
   ...
   */
    ...
    virtual std::any visitAssign(VecMathParser::AssignContext *context) = 0;

    virtual std::any visitPrint(VecMathParser::PrintContext *context) = 0;
    ...
    virtual std::any visitInt(VecMathParser::IntContext *context) = 0;

    virtual std::any visitId(VecMathParser::IdContext *context) = 0;

    virtual std::any visitVector(VecMathParser::VectorContext *context) = 0;
