...
public:
  ...
  enum {
    RuleCompilationUnit = 0, RuleClassDefinition = 1, RuleSuperClass = 2, 
    RuleClassMember = 3, RuleMethodDeclaration = 4, RuleFormalParameters = 5, 
    RuleType = 6, RuleBlock = 7, RuleVarDeclaration = 8, RuleStatement = 9, 
    RuleExpressionList = 10, RuleExpression = 11, RuleAddExpression = 12, 
    RulePostfixExpression = 13, RulePrimary = 14
  };
  ...
  class  MethodMemberContext : public ClassMemberContext {
  public:
    MethodMemberContext(ClassMemberContext *ctx);
  ...
  class  AccessSpecContext : public ClassMemberContext {
  public:
    AccessSpecContext(ClassMemberContext *ctx);
  ...
  class  FieldMemberContext : public ClassMemberContext {
  public:
    FieldMemberContext(ClassMemberContext *ctx);
