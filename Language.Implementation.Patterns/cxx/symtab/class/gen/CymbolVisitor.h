...
public:
   ...
   */
    ...
    virtual std::any visitClassDefinition(CymbolParser::ClassDefinitionContext *context) = 0;

    virtual std::any visitSuperClass(CymbolParser::SuperClassContext *context) = 0;

    virtual std::any visitFieldMember(CymbolParser::FieldMemberContext *context) = 0;

    virtual std::any visitMethodMember(CymbolParser::MethodMemberContext *context) = 0;

    virtual std::any visitAccessSpec(CymbolParser::AccessSpecContext *context) = 0;
