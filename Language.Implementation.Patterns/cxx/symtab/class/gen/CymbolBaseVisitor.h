...
public:
  ...
  virtual std::any visitClassDefinition(CymbolParser::ClassDefinitionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSuperClass(CymbolParser::SuperClassContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitFieldMember(CymbolParser::FieldMemberContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMethodMember(CymbolParser::MethodMemberContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAccessSpec(CymbolParser::AccessSpecContext *ctx) override {
    return visitChildren(ctx);
  }
