...
public:
  ...
  virtual void enterClassDefinition(CymbolParser::ClassDefinitionContext * /*ctx*/) override { }
  virtual void exitClassDefinition(CymbolParser::ClassDefinitionContext * /*ctx*/) override { }

  virtual void enterSuperClass(CymbolParser::SuperClassContext * /*ctx*/) override { }
  virtual void exitSuperClass(CymbolParser::SuperClassContext * /*ctx*/) override { }

  virtual void enterFieldMember(CymbolParser::FieldMemberContext * /*ctx*/) override { }
  virtual void exitFieldMember(CymbolParser::FieldMemberContext * /*ctx*/) override { }

  virtual void enterMethodMember(CymbolParser::MethodMemberContext * /*ctx*/) override { }
  virtual void exitMethodMember(CymbolParser::MethodMemberContext * /*ctx*/) override { }

  virtual void enterAccessSpec(CymbolParser::AccessSpecContext * /*ctx*/) override { }
  virtual void exitAccessSpec(CymbolParser::AccessSpecContext * /*ctx*/) override { }
