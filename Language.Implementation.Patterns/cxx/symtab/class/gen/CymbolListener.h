...
public:
  ...
  virtual void enterClassDefinition(CymbolParser::ClassDefinitionContext *ctx) = 0;
  virtual void exitClassDefinition(CymbolParser::ClassDefinitionContext *ctx) = 0;

  virtual void enterSuperClass(CymbolParser::SuperClassContext *ctx) = 0;
  virtual void exitSuperClass(CymbolParser::SuperClassContext *ctx) = 0;

  virtual void enterFieldMember(CymbolParser::FieldMemberContext *ctx) = 0;
  virtual void exitFieldMember(CymbolParser::FieldMemberContext *ctx) = 0;

  virtual void enterMethodMember(CymbolParser::MethodMemberContext *ctx) = 0;
  virtual void exitMethodMember(CymbolParser::MethodMemberContext *ctx) = 0;

  virtual void enterAccessSpec(CymbolParser::AccessSpecContext *ctx) = 0;
  virtual void exitAccessSpec(CymbolParser::AccessSpecContext *ctx) = 0;
