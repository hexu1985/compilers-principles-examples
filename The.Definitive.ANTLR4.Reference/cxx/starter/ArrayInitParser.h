...
class  ArrayInitParser : public antlr4::Parser {
public:
  enum {
  ...
  explicit ArrayInitParser(antlr4::TokenStream *input);

  ArrayInitParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~ArrayInitParser() override;
